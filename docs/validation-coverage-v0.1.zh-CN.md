...
| M-03 | `validate_net_stand.py`；`render_net_stand_preview.py`；装配页 | `152.5 mm` 网顶、无网顶轨道、网布两端各穿过 `3 mm` 立柱过道并止到立柱外表面、两件整高 U 形卡网夹从桌外侧滑入、网布/绳张力压住卡夹、立柱内嵌单一止挡只防拔出且无穿钉、左右各一个 PVDF 座且与网架保留 `18 mm` 净距；整根 `post_clamp_carrier` 与 `clamp_body_segment` 的共面落座、固定基台坐面 `z=16 mm`、无下插段、桌下 C 形夹、左右十路 M6 `10×56×216 mm` PETG 主体/前后盖/底盖、20 个 M6 包络、竖直采购球头和y+ UI 一体式填平固定板和腔内固定孔的参数与可视关系；固定网柱顶面无孔，M6 下端独立支撑待定义 | 真实网布厚度/张力、止挡防拔行程与释放手感、卡夹夹持与脱开力、共面落座打印配合与耐久、两侧脚部/球路净空、夹体承力、网顶高度、M6 螺纹/光学中心、球头两端螺纹、线缆净空和 NPN 供电/电平；仍需现场量测目标球台兼容性 |

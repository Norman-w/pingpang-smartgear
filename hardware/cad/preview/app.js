...
const ASSEMBLY_STEPS = [
  { number: 1, label: "桌下夹紧与立柱", description: "两侧传统 C 形夹、保护垫、加长 M8 螺杆和旋钮固定在球台边缘；保留桌面夹持开口、压块和螺杆工作区，桌边外侧非接触区沿 y 全深做成实心桥体；上下结构夹臂均加厚到 12 mm，靠球台侧下部支撑厚 40 mm，向外侧以 12 mm 下夹臂收口并形成斜底，接触软垫仍独立可替换。" },

...
ASSEMBLY_COMPONENTS = [
    ...
    },
    {
        ...
        "notes": "默认采购 13mm球【M8外牙】；球头保持竖直，横向 M8 外牙从各自 x 后端进入背面中央加厚 boss，z− 接口向下由采购金属 90°连接器从最低端承接，连接器以两枚 M6 贯穿螺栓固定到网夹立柱。偏航、俯仰、旋转微调依靠采购球头锁紧机构，不打印 90°连接器、灰色适配板或重复金色螺栓。",
    },
    {

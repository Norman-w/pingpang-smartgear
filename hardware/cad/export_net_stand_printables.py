...
ASSEMBLY_COMPONENTS = [
    ...
    {
        "id": "m6-aluminum-detector-bodies",
        "name_zh": "M6 直角十路铝合金主体（一体 T 尾座）",
        "name_en": "M6 right-angle ten-channel aluminum detector bodies",
        "kind": "机加工光学基座",
        "status": "6061-T6 首样 / 待实物量测",
        "printable": False,
        "quantity": "2 根（左右各 1）",
        "scad_part": "m6_detector_body",
        "notes": "中央长条基准 10×56×216 mm，y- 一体 T 尾座向本侧 x 外伸 10 mm，直接加工 M8×1.25 内丝；十路按 20 mm 单列排列，M6 中空外丝沿 x 贯穿，前盖、后盖和底盖不进入 PETG 拼盘。",
    },
    {
        "id": "m6-ballhead-support-chain",
        "name_zh": "M6 金属球头、90°支撑与网夹适配链",
        "name_en": "M6 metal ballhead, 90-degree support and net-clamp adapter chain",
        "kind": "机加工/外购光学承力接口",
        "status": "机械主线 / 待网夹安装面量测",
        "printable": False,
        "quantity": "2 套（左右各 1）",
        "scad_part": "m6_detector_support / m6_mount_adapter / m6_ballhead",
        "notes": "默认采购 13 mm 球头 M8 外牙，球头保持竖直；侧向 M8 外牙直接进入铝合金 T 尾座，90°金属支撑和竖直网夹适配板形成承力链。偏航、俯仰、滚转微调依靠球头锁紧机构，不把 PETG 壳体作为承力件。",
    },
    {
        "id": "m6-ballhead-fasteners",
        "name_zh": "13 mm 球头与金属支撑紧固件",
        "name_en": "13 mm ballhead and metal support fasteners",
        "kind": "外购标准件",
        "status": "待球头/网夹接口量测冻结",
        "printable": False,
        "quantity": "按两套基座",
        "scad_part": "m6_ballhead / m6_detector_support",
        "notes": "采购选项保留 1/4 内牙、1/4 外牙、3/8 外牙、M6 外牙、M8 外牙、M10 外牙；当前默认 M8 外牙。真实螺纹有效长度、旋钮净空、支撑孔位和防松方式需按到货件确认。",
    },
    {
        "id": "m3-hardware",
        "name_zh": "M3 紧固件",

...
ASSEMBLY_COMPONENTS = [
    ...
    {
        "id": "m6-aluminum-rails",
        "name_zh": "M6 直角十路铝合金梳齿安装条",
        "name_en": "M6 right-angle ten-channel comb rails",
        "kind": "机加工光学基座",
        "status": "6061-T6 首样 / 待实物量测",
        "printable": False,
        "quantity": "2 根（左右各 1）",
        "scad_part": "m6_sensor_rail",
        "notes": "首样背骨约 8×42×114 mm，10 个厚 6 mm 水平托舌，按 M6×0.75 竖直安装孔/锁紧螺母防转窝；奇偶通道沿 y 交错以避开 14 mm 直角安装杆。只作铝合金加工预览，不进入 PETG 拼盘。",
    },
    {
        "id": "m6-gimbal-bases",
        "name_zh": "M6 三轴铝合金微调基座",
        "name_en": "M6 three-axis aluminum optical gimbals",
        "kind": "机加工光学基座",
        "status": "机械主线 / 待网夹安装面量测",
        "printable": False,
        "quantity": "2 套（左右各 1）",
        "scad_part": "m6_mount_adapter / m6_gimbal",
        "notes": "固定适配板 + 真正绕 z 轴的水平双层偏航转台 + y 轴俯仰叉架 + x 轴滚转盘；M4 顶丝只做切向微调，最终由 M6 锁紧。",
    },
    {
        "id": "m6-gimbal-hardware",
        "name_zh": "M6 枢轴/锁紧件与 M4 顶丝",
        "name_en": "M6 gimbal pivots, clamps and M4 adjusters",
        "kind": "外购标准件",
        "status": "待加工图和量测冻结",
        "printable": False,
        "quantity": "按两套基座",
        "scad_part": "m6_gimbal",
        "notes": "每套含 M6 锁紧螺钉、M8 枢轴、4 枚 M4×12 梳齿背骨连接螺钉和 M4×0.5 细调顶丝；实际头型、长度和防松方式需按加工厚度确认。",
    },
    {
        "id": "m3-hardware",
        "name_zh": "M3 紧固件",

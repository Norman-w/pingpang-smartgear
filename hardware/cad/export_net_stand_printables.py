...
ASSEMBLY_COMPONENTS = [
    ...
    },
    {
        ...
        "notes": "y=0 竖直分型面采用 9 处横向 M5：操作者侧半体做圆头沉孔，对手侧半体做防转六角螺母窝；只有贴到电子腔空腔边界的连接位增加 boss 柱和十字肋，完全位于实体夹臂里的连接位只保留孔位，避免外壳凸起。左下角连接孔已向外侧移动，电子仓左下角再补 1 处连接点；先装后侧六角螺母，再从 y- 侧拧入螺钉。",
    },
    {
...
def build_export_specs() -> list[ExportSpec]:
    ...
    split_notes = (
        ...
        "电子腔边界前再补 1 处、电子仓左下角再补 1 处连接点，横向 M5 连接件把螺钉头/六角螺母的力传回承力壁。操作者侧"

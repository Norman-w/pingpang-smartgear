...
1. 用 `lower_stand_segment`、`clamp_top_pad`、`clamp_pressure_pad`、每侧三枚标准 M8 螺母（1 枚固定下臂 + 2 枚旋钮对锁）和一段与实物相同厚度的台面样块检查上夹板保护、台底压块、加长圆头螺杆行程、18 齿圆角锯齿旋钮的手拧驱动、实心渐变下部支撑和两侧软垫压痕；
